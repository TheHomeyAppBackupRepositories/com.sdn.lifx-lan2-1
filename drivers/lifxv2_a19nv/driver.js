...
class LIFX_LAN_Driver_lifxv2_a19nv extends MasterDriver {
	...
	onPair(socket) {
		...
		socket.setHandler("list_devices", async (data) => {
			var foundDevices = self.homey.app.GetSupportedDevices(1, 'LIFX A19 Night Vision');
			var pairableDevices = [];
...
module.exports = LIFX_LAN_Driver_lifxv2_a19nv;
