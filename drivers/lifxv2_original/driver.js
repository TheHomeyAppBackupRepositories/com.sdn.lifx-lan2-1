...
class LIFX_LAN_Driver_lifxv2_original extends MasterDriver {
	...
	onPair(socket) {
		...
		socket.setHandler("list_devices", async (data) => {
			var foundDevices = self.homey.app.GetSupportedDevices(1, 'LIFX Original 1000');
			var pairableDevices = [];
...
module.exports = LIFX_LAN_Driver_lifxv2_original;
