...
class LIFX_LAN_Driver_lifxv2_900_w_br30_hv extends MasterDriver {
	...
	onPair(socket) {
		...
		socket.setHandler("list_devices", async (data) => {
			var foundDevices = self.homey.app.GetSupportedDevices(1, 'LIFX White 900 BR30 (High Voltage)');
			var pairableDevices = [];
...
module.exports = LIFX_LAN_Driver_lifxv2_900_w_br30_hv;
