...
class LIFX_LAN_Driver_lifxv2_hue_1000_br30 extends MasterDriver {
	...
	onPair(socket) {
		...
		socket.setHandler("list_devices", async (data) => {
			var foundDevices = self.homey.app.GetSupportedDevices(1, 'LIFX Color 1000 BR30');
			var pairableDevices = [];
...
module.exports = LIFX_LAN_Driver_lifxv2_hue_1000_br30;
