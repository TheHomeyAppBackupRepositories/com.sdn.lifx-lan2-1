...
class LIFX_LAN_Driver_lifxv2_candle extends MasterDriver {
	...
	onPair(socket) {
		...
		socket.setHandler("list_devices", async (data) => {
			var foundDevices = self.homey.app.GetSupportedDevices(1, 'LIFX Candle');
			var pairableDevices = [];
...
module.exports = LIFX_LAN_Driver_lifxv2_candle;
