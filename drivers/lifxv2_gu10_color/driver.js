...
class LIFX_LAN_Driver_lifxv2_gu10_color extends MasterDriver {
	...
	onPair(socket) {
		...
		socket.setHandler("list_devices", async (data) => {
			var foundDevices = self.homey.app.GetSupportedDevices(1, 'LIFX GU10 Color');
			var pairableDevices = [];
...
module.exports = LIFX_LAN_Driver_lifxv2_gu10_color;
