...
class LIFX_LAN_Driver_lifxv2_white extends MasterDriver {
	...
	onPair(socket) {
		...
		socket.setHandler("list_devices", async (data) => {
			var foundDevices = self.homey.app.GetSupportedDevices(1, 'LIFX White');
			var pairableDevices = [];
...
module.exports = LIFX_LAN_Driver_lifxv2_white;
